 ...
 */
typedef struct {
    //resolved成员为直接指定的上有服务器地址，upstream则根据负载均衡算法提供一个上游服务器地址
...
struct ngx_http_upstream_s {
    ...
    /**
     * 收到上游服务器的响应后就会回调 process_header方法, 解析上游服务器返回响应的包头 r->upstream->buffer，试图从中解析完整的响应头部
