...
/**
 * 测试r的响应头content_type是否在types_hash表示的hash中
 */
void *
 ...
 * ①0。在没有特殊需求的情况下都应该填写它； 
 * ②NGX_HTTP_SUBREQUEST_IN_MEMORY。这个宏会将子请求的subrequest_in_memory标志位置为1，
    ...
    ngx_http_post_subrequest_t *ps, ngx_uint_t flags)
{
    ...
    //初始化子请求的headers_out，该链表存储待发送的http响应包体
